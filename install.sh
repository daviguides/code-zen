...
# ============================================================================
# Code-zen Installer
# Installs the Code-zen architecture framework to ~/.claude/code-zen
# ============================================================================
...
# --- Configuration ---
readonly REPO_URL="https://github.com/daviguides/code-zen.git"
readonly TMP_DIR="/tmp/code-zen-$$"
readonly CLAUDE_DIR="$HOME/.claude"
readonly TARGET_DIR="$CLAUDE_DIR/code-zen"
readonly SOURCE_SUBDIR="code-zen"

# --- Marketplace Configuration ---
readonly MARKETPLACE_URL="https://github.com/daviguides/claude-marketplace.git"
readonly PLUGIN_IDENTIFIER="code-zen@daviguides"
...
clone_repository() {
  printf "%b\n" "${BLUE}Cloning Code-zen repository...${NC}"
...
validate_source_structure() {
  ...
  if [ ! -d "$src_subdir" ]; then
    ...
    printf "%s\n" "Repository structure may have changed. Verify 'code-zen/' exists at repo root."
    exit 1
  fi
}
...
install() {
  printf "%b\n" "${BLUE}Installing code-zen to $TARGET_DIR...${NC}"
  ...
  printf "%b\n\n" "${GREEN}✓ code-zen installed successfully!${NC}"
}
...
print_next_steps() {
  ...
  printf "%b\n\n" "${BLUE}Next steps:${NC}"
  printf "%s\n" "1. Use /load-code-zen-context command to load Code-zen context when needed"
  printf "%s\n" "2. Or reference specific specs/context files in your prompts"
  printf "%s\n" "3. Docs: https://github.com/daviguides/code-zen"
}
